...
Create the first runnable API in `api/`: Kotlin/Spring Boot, MySQL 8.4, Liquibase, health checks, and Docker. Business endpoints, YouTube tables/jobs, authentication, frontend work, and media processing belong to later milestones. See [YouTube monitoring](02-api-youtube-monitoring-plan.md) for the next milestone.
