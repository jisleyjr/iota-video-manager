...
2. [YouTube monitoring](02-api-youtube-monitoring-plan.md): stored video queries, synchronization, retention, and ShedLock jobs. This remains planned follow-up work.
